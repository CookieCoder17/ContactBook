...
## Usage:
You may launch the App simply by importing the given directory and opening the 'ContactBook_exec.jar' executable. A GUI frame should appear with the operations on the right panel and a screen on the left. Below are some of the operations in the Contact Book. There are more avaible than shown below.
<p align="left">
